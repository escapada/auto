...
Refinery::Images.configure do |config|
  ...
  config.user_image_sizes = {:news=>"280x210#", :small=>"110x110>", :medium=>"225x255>", :large=>"450x450>"}
  ...
  # config.dragonfly_secret = "7fc5c17bfafb9ad467e280e83023c69e3f498ff3ac101d99"
  # If you decide to trust file extensions replace :ext below with :format
  # config.dragonfly_url_format = "/system/images/:job/:basename.:ext"
  # config.dragonfly_url_host = ""
  # config.datastore_root_path = "/home/ivan/Sites/auto/public/system/refinery/images"
