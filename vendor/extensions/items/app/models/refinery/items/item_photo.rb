  ...
  module Items
    class ItemPhoto < Refinery::Core::BaseModel
      ...
      attr_accessible :main, :image, :item_id
  		...
  		has_attached_file :image, :styles => { :medium => "293x170/#", :thumb => "100x100/#>", :big => "620x373/#" }, :default_url => "/images/:style/missing.png"#, :processors => [:watermark]#, :default_url => "/images/:style/missing.png"
